...
import { FileText, User, Clock, Phone, MessageCircle, PhoneIncoming, PhoneOutgoing, BarChart3, Brain, TrendingUp } from 'lucide-react-native';
...
export default function NotesScreen() {
  ...
  return (
    <View style={styles.container}>
      <Stack.Screen options={{ title: 'Notes & Summary' }} />
